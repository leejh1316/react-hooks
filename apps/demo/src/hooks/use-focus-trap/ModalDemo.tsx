  ...
  return (
    <section className="demo-section">
      ...
      <p className="description">
        <kbd className="kbd">Tab</kbd> / <kbd className="kbd">Shift+Tab</kbd>이 모달 내부에서 순환합니다 ·{" "}
        <kbd className="kbd">Esc</kbd>로 닫기
      </p>
      ...
      {isOpen && (
        <>
          ...
          >
            <h3 id="modal-title" className="modal-title">정말 삭제하시겠습니까?</h3>
