  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      <header className="mb-10">
        <h1 className="mt-0 mb-2 text-[1.75rem] font-bold font-mono">@leejaehyeok/react-hooks</h1>
        <p className="mt-0 text-base text-gray-500 dark:text-gray-400">React Custom Hooks 모음</p>
      </header>
        ...
        {hookRegistry.map((hook) => (
          ...
          >
            <div className="flex items-start justify-between gap-3 mb-2.5">
              <code className="text-[0.95rem] font-semibold font-mono text-indigo-600 dark:text-indigo-400">{hook.name}</code>
            ...
            <p className="m-0 text-sm text-gray-500 dark:text-gray-400 leading-relaxed">{hook.description}</p>
          </Link>
        ))}
      </div>
    </div>
