...
/* ──────────────────────────────────────────────
   ...
   마운트 시 한 번 생성된 인터벌이 클로저에 캡처된 초기 count(0)만 계속 읽습니다
   ────────────────────────────────────────────── */
...
const NoLatestRefDemo = () => {
  ...
  useEffect(() => {
    // 의존성 배열이 비어 있어 인터벌은 마운트 시점의 count(0)를 클로저로 캡처합니다.
  ...
  return (
    <div className="flex w-full flex-col items-center gap-4">
      ...
      <p className="text-body-3 text-ink-tertiary">count를 아무리 올려도 1초마다 실행되는 인터벌은 마운트 시점의 0만 읽습니다.</p>
